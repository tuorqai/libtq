...
static tq_font unispace; // font
static bool alphabet[26]; // array of pressed letter keys
...
static void on_key_released(tq_key key)
{
    if (key >= TQ_KEY_A && key <= TQ_KEY_Z) {
...
int main(int argc, char *argv[])
{
    ...
    // Load font.
    unispace = tq_load_font_from_file("assets/fonts/unispace.ttf", 36.0f, 400);
