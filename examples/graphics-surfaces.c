...
static float rotation0 = 0.0f;
static float rotation1 = 30.0f;
static float rotation2 = 60.0f;

static tq_vec2i surf0_size = { 16, 16 };
static tq_vec2i surf1_size = { 32, 32 };
static tq_vec2i surf2_size = { 64, 64 };

static tq_surface surf0;
static tq_surface surf1;
static tq_surface surf2;
...
int main(int argc, char *argv[])
{
    ...
    tq_set_antialiasing_level(16);

    tq_initialize();

    surf0 = tq_create_surface(surf0_size);
    surf1 = tq_create_surface(surf1_size);
    surf2 = tq_create_surface(surf2_size);
